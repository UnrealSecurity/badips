# Bad IP blacklist
![badips-live-stat](https://i.ibb.co/mSySTYN/image.png)

## Description
The site above is available [here](https://leet.network/badips/badips-map-beta) and connects to our WebSocket API endpoint to receive alerts when automated systems scan our ports and/or attempt to exploit services binded to them. 
